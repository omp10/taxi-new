  ...
  return (
    <div className="flex h-full flex-col bg-[#F8FAFC] font-poppins min-h-[38rem] overflow-hidden">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200/60 bg-white px-6 py-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 text-xs font-bold rounded-xl border transition-all hover:scale-[1.02] ${
              showDetailsPanel ? 'border-slate-350 bg-slate-100 text-slate-800' : 'border-slate-200 bg-white text-slate-700'
            }`}
          >
            <Info size={14} />
          ...
          {['ALL', 'USERS', 'DRIVERS', 'VENDORS', 'SUPPORT', 'UNREAD', 'ACTIVE', 'RESOLVED'].map((tab) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all hover:scale-[1.02] ${
                  filterTab === tab
      ...
      <div className="flex flex-1 min-h-0 min-w-0 bg-[#F8FAFC]">
        ...
        <aside className={`flex flex-col shrink-0 bg-white border-r border-slate-200/60 w-full md:w-[28%] transition-all duration-300 ${
              ...
              visibleConversations.map((conversation) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-start gap-3 rounded-[16px] border p-3.5 text-left transition-all relative group ${
                      isSel
                  ...
                  >
                    <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border text-slate-600 bg-white ${
                      isSel ? 'border-amber-200 text-amber-700 shadow-sm' : 'border-slate-200'
                    }`}>
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="flex items-center gap-1.5 mt-1 leading-none">
                        <span className={`text-[9px] font-black uppercase tracking-wider ${
                          peerRole === 'driver' ? 'text-amber-600' : 'text-indigo-600'
                        }`}>
                          {peerRole}
                        </span>
        ...
        <main className={`flex-1 min-w-0 min-h-0 flex flex-col bg-white border-r border-slate-200/60 transition-all duration-300 ${
          ...
          {selectedConversation ? (
                      ...
                      return (
                        <div key={message.id} className={`flex ${isMine ? 'justify-end' : 'justify-start'}`}>
                          <div className={`flex max-w-[78%] items-end gap-2.5 ${isMine ? 'flex-row-reverse' : ''}`}>
                            ...
                            <div>
                              <div
                                className={`rounded-[18px] px-4 py-3 shadow-sm text-xs leading-relaxed ${
                                  isMine
              ...
              <div className="border-t border-slate-200/60 bg-white p-4">
                ...
                <div className="mx-auto flex max-w-3xl items-center gap-2.5 rounded-[18px] border border-slate-250 bg-slate-50 px-3.5 py-2">
                  ...
                  <button
                    ...
                    className={`inline-flex h-9 w-9 items-center justify-center rounded-xl text-white transition-all ${
                      sending || !draft.trim()
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-white p-8 text-center">
              ...
              <h3 className="text-base font-bold text-slate-900 font-poppins">Welcome to Rydon Support Center</h3>
